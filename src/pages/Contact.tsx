...
const Contact = () => {
    return (
        <div className='w-full h-screen flex flex-col justify-center items-center font-sg dark:bg-[#1F1F1F]'>
            <Navbar />

            <p className='flex-1 flex flex-row gap-10 justify-center items-center'>
                <div className='flex flex-col gap-10'>
                    <p className='text-4xl'>Reach out to us!</p>
